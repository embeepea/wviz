...
module.exports = function(state) {
    ...
    return [
        ...
        //{ seq: "br",
        //  action: function() { rain.beginRain(state.wviz.settings, state, state.wviz.settings.drop.fallSpeed, state.wviz.requestRender); },
        //  msgfunc: function() { return "begin rain"; } },
        //{ seq: "er",
        //  action: function() { rain.endRain(state, state.wviz.requestRender); },
